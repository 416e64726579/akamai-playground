...
func (n *netlist) Error(r *http.Response) error {
	var e Error
	...
	if err != nil {
		n.Log(r.Request.Context()).Errorf("reading error response body: %s", err)
	...
	if err := json.Unmarshal(body, &e); err != nil {
		n.Log(r.Request.Context()).Errorf("could not unmarshal API error: %s", err)
